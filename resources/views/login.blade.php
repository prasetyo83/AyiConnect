        ...
        <div class="login-container">
            <div class="w-form">
                <form id="wf-form-Login-form" name="wf-form-Login-form" data-name="Login form" method="POST"
                    action="{{ route('plogin') }}" class="form-2">
                    @csrf
                    <label for="name" class="nentitujt">Username/Email</label><input type="text" class="w-input"
                        maxlength="256" name="login" data-name="login" placeholder="Input email or username"
                        id="login" required>
                    <label for="password" class="nentitujt">Password</label><input type="password"
                        class="text-field-4 w-input" maxlength="256" name="password" data-name="password" placeholder=""
                        id="password" required><input type="submit" value="Sign In" data-wait="Please wait..."
